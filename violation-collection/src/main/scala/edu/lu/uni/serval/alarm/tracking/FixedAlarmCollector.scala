...
object FixedAlarmCollector extends LazyLogging {
  def main(args: Array[String]): Unit = {
    collectFixedAlarms("/data/bowen/data/Transformation4J/FBMining-ori/fixed-alarms.list",
      "/home/bowen/Desktop/research/Transformation4J/others/fb_mining/findbugs-violations/data/repos/repos-%s/%s/.git",
      "/data/bowen/data/Transformation4J/FBMining-ori/prj-pack.map",
      "/data/bowen/data/Transformation4J/FBMining-ori/vtype-stat.csv",
      "/data/bowen/data/Transformation4J/FBMining-ori/summary-project-vtype.csv"
    )
